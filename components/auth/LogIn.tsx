    ...
    <div className="flex items-center justify-center min-h-screen bg-primary py-20">
      <div className="flex items-center gap-8 flex-col">
        ...
        <div className="bg-white w-full max-w-md rounded-xl p-8 shadow-lg">
          <h2 className="text-xl font-bold text-text-heading mb-1 text-center">
            Continue your Learning
          </h2>
          <p className="text-center text-sm text-[#8D9296] mb-6">
            Access your courses and continue building your skills.
          </p>

          <form className="flex flex-col gap-6">
            <div>
              <label className="text-sm text-text-subtext">
                Email Address
              </label>
              <input
                type="email"

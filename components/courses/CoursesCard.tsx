      ...
      <Link  href={'/'} className='p-4 rounded-lg bg-white border cursor-pointer border-light-border '>
        <div>
            <div className='flex flex-col gap-3'>
                 ...
                 <div>
                      <h4 className='mb-1 text-lg font-semibold text-text-heading line-height-lg line-clamp-3 font-geologica'>{course.title}</h4>
                      <h6 className='mb-2 text-vxs font-regular text-[#343A40A3]'>{course.instructor_name}</h6>
